...
// Webpack utilise ce module pour compresser tout ls fichiers css en seul fichier.
...
module.exports = (env) => {
  ...
  return {
    ...
    module: {
      rules:  [
        // "babel-loader": "^8.1.0", "@babel/core": "^7.11.6", "@babel/preset-env": "^7.11.5", to add in package.json
        // { 
        //   test: /\.js$/,
